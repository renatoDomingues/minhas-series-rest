...
mongoose
  ...
  */
  ...
  mongoose
    .connect('mongodb+srv://minhas-series-rest:<password>@cluster0.2rxku.mongodb.net/myFirstDatabase?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
    .then(() => {
    createInitialUsers()
    app.listen(port, () => console.log('listening...'))
  })
